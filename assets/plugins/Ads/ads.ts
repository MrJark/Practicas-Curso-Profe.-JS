//vamos a usar un sigleton porque podemos hacer que cada bunner sea distinto al resto 
...
class Ads {
    ...
    private initAd () {
        this.ads = [...ALL_ADS]; //para hacer una copia de un arreglo usamos los 3 puntos y el arreglo que queremos copiar -> quiero copiar el arreglo ' ALL_ADS ' lo que hago es ' new Arreglo = [...ALL_ADS] '
    };
